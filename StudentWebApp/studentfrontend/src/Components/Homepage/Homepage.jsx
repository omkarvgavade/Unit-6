...
function Homepage() {
    ...
    useEffect(() => {
        setUrl(`http://localhost:2345/students${location.search}`)
        getData()
    }, [location.search])
    function getData() {
                ...
                <div className="studentInfo">
                    <StudentShowStyled>
                        <div>
                            ...
                            <BtnsStyled>
                                <Button color="primary" variant="contained" onClick={handleOpen}>Create Student</Button>
                                    ...
                                    <TableBody>
                                        {studentData.map((el) => (
                                            <StyledTableRow key={el.name}>
                                                ...
                                                }}>Edit Student</Button></StyledTableCell>
                                            </StyledTableRow>
                                        ))}
                                    </TableBody>
                                </Table>
                        ...
                        <FilterStyled>
                            ...
                            <div>
                                <Button onClick={() => {
                                    ...
                                    RefreshPage()
                                }} variant="contained" color="primary">Filter</Button>
                            </div>
                        </FilterStyled>
                    </FilteringStyled>
                </div>
